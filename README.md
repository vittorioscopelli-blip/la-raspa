...
- **Jugadores lentos:** si alguien demora más de 20 segundos en su turno, los demás pueden votar que una IA básica juegue por él y quede expulsado. Sólo se aprueba por unanimidad; si el jugador responde antes, la votación se cancela.
- **Abandonar:** el botón 🚪 permite abandonar la partida con confirmación. La IA sigue jugando esas cartas y el jugador queda libre para otra partida.
